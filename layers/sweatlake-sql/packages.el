    ...
    (progn
      (setq spacemacs-sql-highlightable sql-product-alist
            spacemacs-sql-startable (remove-if-not
                                     (lambda (product) (sql-get-product-feature
                                                        (car product) :sqli-program))
                                     sql-product-alist)
...
(defun sweatlake-sql/init-sql-indent ()
  (use-package sql-indent
    :defer t))

(defun sweatlake-sql/init-sqlup-mode ()
...
(defun sweatlake-sql/post-init-company ()
